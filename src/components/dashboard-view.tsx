    ...
    <main className="min-h-screen bg-[#f4f6f4] text-slate-900">
      ...
      <div className="mx-auto -mt-14 max-w-7xl space-y-6 px-5 pb-16 lg:px-8">
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          <Section title="Status distribution" subtitle="Why 15,661 of 20,000 rows enter normal matching" action={<ShieldCheck className="text-slate-300" size={22} />}><DistributionBars items={data.statusDistribution.slice(0, 10)} /></Section>
